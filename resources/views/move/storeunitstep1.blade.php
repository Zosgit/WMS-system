@extends('layouts.app')
@section('title') {{ 'Przesunięcie opakowania' }} @endsection
@section('content')
        ...
        <div class="card-body">
            ...
            @if (isset($storeunit->id))
                <div class="row mb-4">
                    ...
                    <div class="row mt-4 float-center ">
                        <a href="{{ route('move.su2',['id' => $storeunit->id]) }}"
                            class="btn btn-primary px-4 btn-sm ">Wyszukaj miejsce >></a>
                    </div>
            ...
            @else
                @if($start <> '')
                <div class="row mb-4">
                    <div class="text-danger"><strong>Nie znaleziono opakowania!</strong></div>
                </div>
                @endif
            @endif
        </div>
